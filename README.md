...
با توجه به اهمیت و چندبخشی بودن مسئله ۱، مسئولیت اصلی این مسئله بین علی و بنیامین تقسیم شده است.
...
در صورت نیاز برای KMeans می‌توان ویژگی‌های زیر را نیز اضافه کرد:
...
اگر برای سرعت اجرا از sample استفاده شود، روش sample باید در نوت‌بوک توضیح داده شود و علی و بنیامین باید از منطق یکسان برای sample استفاده کنند.
...
مسئولیت علی در مقدمه مسئله ۱:

* توضیح هدف سیستم توصیه‌گر ملک
* توضیح اینکه خوشه‌بندی چگونه می‌تواند برای پیشنهاد آگهی‌های مشابه استفاده شود
* تحلیل و انتخاب ویژگی‌های مناسب برای خوشه‌بندی
* توضیح دلیل انتخاب هر ویژگی
* توجه به محدود بودن تعداد ویژگی‌ها برای جلوگیری از نفرین ابعاد
* توضیح دلیل استفاده از `target_price` یا `log_target_price`
* توضیح دلیل محدود کردن تحلیل مکانی به `UTM zone 39S`

مسئولیت علی در بخش ۱:

* آماده‌سازی داده مشترک clustering با فیلتر پایه
* ساخت `log_target_price`
* انتخاب featureهای نهایی برای KMeans
* مدیریت مقدارهای گم‌شده در featureهای انتخاب‌شده
* scale کردن ویژگی‌ها
* اجرای KMeans با ۱۰ خوشه
* اضافه کردن label خوشه به داده
* رسم scatter plot خوشه‌ها
* نمایش مرکز خوشه‌ها روی نمودار
* نام‌گذاری مناسب محورها و عنوان نمودار
* ساخت جدول خلاصه برای هر خوشه
* تفسیر خوشه‌ها از نظر موقعیت، قیمت، متراژ و کاربرد در توصیه‌گر

خروجی مورد انتظار علی:
...
بنیامین باید از همان فایل مبنا، همان فیلتر پایه، همان تعریف `log_target_price` و همان منطق sample استفاده کند تا خروجی او با بخش علی قابل ادغام باشد.
...
* کار علی و بنیامین در مسئله ۱ باید از نظر load data، فیلتر، featureهای پایه و sample یکسان باشد.
...
مسئله ۱، مقدمه و بخش ۱: مسئول علی
مسئله ۱، بخش ۲ و بخش ۳: مسئول بنیامین
مسئله ۲: اولویت دوم، شروع baseline توسط علی در صورت داشتن زمان
```
